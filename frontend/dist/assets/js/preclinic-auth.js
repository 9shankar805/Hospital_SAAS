/**
 * NepXMedica Hospital SaaS - Global Auth & Session Manager
...
(function () {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        const loginForms = document.querySelectorAll('form[action*="login"], form.login-form, #loginForm, form');
        loginForms.forEach(form => {
            const isLoginForm = form.querySelector('input[type="email"], input[name="email"]') && form.querySelector('input[type="password"], input[name="password"]');
            ...
            form.addEventListener('submit', async (e) => {
                ...
                try {
                    const res = await fetch(`${API_BASE}/reset-password`, {
                        ...
                        headers: { 'Content-Type': 'application/json' },
                        body: JSON.stringify({
                            email: emailInput ? emailInput.value.trim() : 'admin@nepxmedica.com',
