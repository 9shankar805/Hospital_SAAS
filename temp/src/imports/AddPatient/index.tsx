import svgPaths from "./svg-bjz1u530r1";
import imgAvatarCircle from "./d3a208331b29eccdbc470584100d552302c63856.png";
import imgAvatarCircle1 from "./b5ff9db95c95717dbae72a72e7bc65435f63d45d.png";
import imgAvatarCircle2 from "./80e84b075f3837bd9978eb558fb8faddcc132ebb.png";
import imgAvatarCircle3 from "./4a07c720d0ec82f1d264d24f0097fbd50539277e.png";
import imgAvatarCircle4 from "./4ba3c40c176205184f0e1e26aa49d5e95303c471.png";
import imgAvatarCircle5 from "./be1f6194c32500f95a916b94c20fbc1d405bf898.png";
import imgAvatarCircle6 from "./f719b0bb6420ab629dde079f6059131af32470ca.png";
import imgAvatarCircle7 from "./63296b46dcd88769842b06ed1ce550e0c29e994a.png";
import imgAvatarCircle8 from "./dee57099f569cd8f8485d462d593d5c9cd055a8c.png";
import imgAvatarCircle9 from "./5a11460dfe5c141d28e08bd21633d6ac859dc23b.png";
import imgAvatarCircle10 from "./2b08270329f562256114b08d9c02d39f0f023a81.png";
import imgAvatarCircle11 from "./d270edbb86ce9a31957835d2db864cde3cf25734.png";
import imgAvatarCircle12 from "./d9bbc22e515175cfef050c1bc17c14b6a986cf2e.png";
import imgAvatarCircle13 from "./d895df3755505ef3af8d80e71522d52a7e5f1d50.png";
import imgAvatarCircle14 from "./78a56f17759aef4a48c923dc2bcc04a5b296bf0d.png";
import imgAvatarCircle15 from "./0c9b539f7dc225c75c3616a88e5e006057c1f646.png";
...
function MenuName14() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Menu Name">
      ...
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px not-italic relative text-[#0a1b39] text-[14px]">
...
function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center px-[24px] py-[8px] right-0 top-[927px] w-[1164px]" data-name="Footer">
...
function TitleContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[339px]" data-name="Title Container">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Patient Grid</p>
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[614px]" data-name="Header Actions">
      ...
      <div className="bg-[#2e37a4] content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">{`New Patient `}</p>
      </div>
    </div>
  );
}
...
function Container63() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start justify-center not-italic relative shrink-0 whitespace-nowrap" data-name="Container">
...
function AppointmentDate() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Mon, 30 Apr 2025</p>
    </div>
  );
}
...
function Location() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Green Square, New York, USA</p>
    </div>
  );
}
...
function AppointmentDate1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Wed, 15 Apr 2025</p>
    </div>
  );
}
...
function Location1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Lakeview Drive, Chicago, USA</p>
    </div>
  );
}
...
function AppointmentDate2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Tue, 02 Apr 2025</p>
    </div>
  );
}
...
function Location2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Ocean Avenue, Miami, USA</p>
    </div>
  );
}
...
function AppointmentDate3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Thu, 27 Mar 2025</p>
    </div>
  );
}
...
function Location3() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Elm Road, Austin, USA</p>
    </div>
  );
}
...
function AppointmentDate4() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Thu, 12 Mar 2025</p>
    </div>
  );
}
...
function AppointmentDate5() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Fri, 05 Mar 2025</p>
    </div>
  );
}
...
function Location5() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Maple Street, San Francisco, USA</p>
    </div>
  );
}
...
function AppointmentDate6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Sat, 24 Feb 2025</p>
    </div>
  );
}
...
function Location6() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Pine Valley, Seattle, USA</p>
    </div>
  );
}
...
function AppointmentDate7() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Sat, 16 Feb 2025</p>
    </div>
  );
}
...
function AppointmentDate8() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Tue, 01 Feb 2025</p>
    </div>
  );
}
...
function Location8() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">River Walk, Houston, USA</p>
    </div>
  );
}
...
function AppointmentDate9() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Mon, 25 Jan 2025</p>
    </div>
  );
}
...
function Location9() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Forest Hill, Denver, USA</p>
    </div>
  );
}
...
function AppointmentDate10() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Thu, 22 Jan 2025</p>
    </div>
  );
}
...
function Location10() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Garden Circle, Orlando, USA</p>
    </div>
  );
}
...
function AppointmentDate11() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Sat, 18 Jan 2025</p>
    </div>
  );
}
...
function Location11() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Crystal Court, Atlanta, USA</p>
    </div>
  );
}
...
function AppointmentDate12() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Wed, 15 Jan 2025</p>
    </div>
  );
}
...
function Location12() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Oakwood Street, Phoenix, USA</p>
    </div>
  );
}
...
function AppointmentDate13() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Fri, 10 Jan 2025</p>
    </div>
  );
}
...
function Location13() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Location">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Hilltop Lane, Dallas, USA</p>
    </div>
  );
}
...
function Details15() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Details">
      <div className="relative shrink-0 size-[48px]" data-name="Avatar Circle">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="48" src={imgAvatarCircle15} width="48" />
      </div>
      <Container105 />
    </div>
  );
...
function AppointmentDate14() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Appointment Date">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Last Appointment : Tue, 04 Jan 2025</p>
    </div>
  );
}
...
function Option() {
  return (
    <div className="bg-[#f5f6f8] relative rounded-[6px] shrink-0 w-full" data-name="Option">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[7px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Edit</p>
        </div>
      </div>
    </div>
  );
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center justify-between px-[20px] py-[15px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">
            <p className="leading-[24px]">Add New Patient</p>
          </div>
    ...
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Form Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`First Name `}</span>
      ...
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input Blank">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">Last Name</span>
...
function FlagUs() {
  return (
    <div className="h-[10px] relative shrink-0 w-[14px]" data-name="flag/US">
      <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 14 10">
        <g clipPath="url(#clip0_1_20566)" id="flag/US">
          <path d="M0 0H14V10H0V0Z" fill="var(--fill-0, white)" id="Vector" />
          <g id="Group">
            <path d={svgPaths.p2797c00} fill="var(--fill-0, #D80027)" id="Vector_2" />
          </g>
          <path d="M0 0H7V5.38304H0V0Z" fill="var(--fill-0, #2E52B2)" id="Vector_3" />
          <g id="Group_2">
            <path d={svgPaths.p2ab94000} fill="var(--fill-0, white)" id="Vector_4" />
          </g>
        </g>
        <defs>
...
function Country() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Country">
      <FlagUs />
      <Number />
    </div>
  );
    ...
    <div className="bg-white drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] h-[36px] relative rounded-[6px] shrink-0 w-full" data-name="Input">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[6px] relative size-full">
          <Country />
          <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#9da4b0] text-[14px] whitespace-nowrap">
            <p className="leading-[21px]">000-000-0000</p>
          </div>
        </div>
      </div>
    </div>
...
function FormRow1() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Form Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Phone Number">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
...
function FormRow3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-w-px relative" data-name="Form Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with date">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`DOB `}</span>
          <span className="leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input5 />
      </div>
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Form Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`Primary Doctor `}</span>
          <span className="leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input4 />
      </div>
...
function SelectOption2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] h-full items-center justify-between min-w-px relative" data-name="Select Option">
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] min-w-px not-italic relative text-[#6c7688] text-[14px]">
        <p className="leading-[21px]">Select</p>
      </div>
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="chevron-down">
        <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
...
function FormRow4() {
  return (
    <div className="content-stretch flex gap-[16px] items-start relative shrink-0 w-full" data-name="Form Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`Gender `}</span>
          <span className="leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input6 />
      </div>
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">Blood Group</span>
...
function Form() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Form">
      ...
      <FormRow2 />
      <FormRow4 />
      <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-[372px]" data-name="Input with Select">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-full">
          <span className="leading-[21px]">{`Status `}</span>
          <span className="leading-[21px] text-[#ef1e1e]">*</span>
        </p>
        <Input8 />
      </div>
...
function PatientInformation() {
  return (
    <div className="relative shrink-0 w-full" data-name="Patient Information">
      ...
      <div className="content-stretch flex flex-col gap-[20px] items-start p-[20px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
          <p className="leading-[19.2px]">Patient Information</p>
        </div>
        <Form />
      </div>
    </div>
...
function FormRow8() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-w-px relative" data-name="Form Row">
      <FormRow9 />
    </div>
  );
}
...
function FormRow13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[16px] items-center min-w-px relative" data-name="Form Row">
      <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-w-px relative" data-name="Input with Select">
...
function FormRow12() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Form Row">
      <FormRow13 />
    </div>
  );
}
...
function FormRow6() {
  return (
    <div className="content-stretch flex flex-col gap-[16px] items-start relative shrink-0 w-full" data-name="Form Row">
      <FormRow7 />
      <FormRow12 />
    </div>
  );
...
function AddressInformation() {
  return (
    <div className="relative shrink-0 w-full" data-name="Address Information">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-[0_0_-1px_0] pointer-events-none" />
      <div className="content-stretch flex flex-col gap-[20px] items-start p-[20px] relative size-full">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[16px] whitespace-nowrap">
...
function Content() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Content">
      <Content1 />
    </div>
  );
}
...
function FooterActions() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[760px]" data-name="Footer Actions">
      ...
      <div className="bg-[#2e37a4] content-stretch flex items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">Add New Patient</p>
      </div>
    </div>
  );
}
...
function Popup() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute content-stretch flex flex-col items-start left-1/2 top-[calc(50%-0.31px)] w-[800px]" data-name="Popup">
      <Container107 />
    </div>
  );
}
...
export default function AddPatient() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Add Patient">
      <div className="absolute bg-white content-stretch flex flex-col items-start left-0 rounded-br-[6px] rounded-tr-[6px] top-0 w-[276px]" data-name="Sidebar Default">
        <Container />
      </div>
      ...
      <Footer />
      <MainContainer />
      <div className="absolute bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col gap-[4px] items-start justify-center left-[1247px] p-[12px] rounded-[6px] top-[560px] w-[150px]" data-name="Dropdowns">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
        <Option />
        <Option1 />
      </div>
      <div className="-translate-x-1/2 absolute backdrop-blur-[3px] bg-[rgba(3,3,3,0.5)] h-[1109px] left-1/2 top-0 w-[1440px]" />
      <Popup />
    </div>
  );
}