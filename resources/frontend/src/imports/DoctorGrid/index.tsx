import svgPaths from "./svg-koxv8jghbg";
...
function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center px-[24px] py-[8px] right-0 top-[1108px] w-[1164px]" data-name="Footer">
    ...
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">Doctors</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift2 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] text-left whitespace-nowrap">Add Doctor</p>
        </div>
      </div>
    </div>
  );
...
function Container187() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Container">
      <Container188 />
      <div className="bg-white drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] h-[45px] relative rounded-[6px] shrink-0 w-full" data-name="Dark Mode Component">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
        <div className="flex flex-row items-center size-full">
...
function SidebarScroll() {
  return (
    <div className="absolute content-stretch flex h-[1155px] items-start left-0 top-0" data-name="Sidebar  Scroll">
...
export default function DoctorGrid() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Doctor Grid">
      <Footer />
      <MainContainer />
      <div className="absolute bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col gap-[4px] items-start justify-center left-[1244px] p-[12px] rounded-[6px] top-[362px] w-[150px]" data-name="Dropdowns">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
        <Option />
        <Option1 />
      </div>
