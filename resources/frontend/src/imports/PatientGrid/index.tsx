import svgPaths from "./svg-z79t9jmf5g";
import imgAvatarCircle from "./b5ff9db95c95717dbae72a72e7bc65435f63d45d.png";
import imgAvatarCircle1 from "./80e84b075f3837bd9978eb558fb8faddcc132ebb.png";
import imgAvatarCircle2 from "./4a07c720d0ec82f1d264d24f0097fbd50539277e.png";
import imgAvatarCircle3 from "./4ba3c40c176205184f0e1e26aa49d5e95303c471.png";
import imgAvatarCircle4 from "./be1f6194c32500f95a916b94c20fbc1d405bf898.png";
import imgAvatarCircle5 from "./f719b0bb6420ab629dde079f6059131af32470ca.png";
import imgAvatarCircle6 from "./63296b46dcd88769842b06ed1ce550e0c29e994a.png";
import imgAvatarCircle7 from "./dee57099f569cd8f8485d462d593d5c9cd055a8c.png";
import imgAvatarCircle8 from "./5a11460dfe5c141d28e08bd21633d6ac859dc23b.png";
import imgAvatarCircle9 from "./2b08270329f562256114b08d9c02d39f0f023a81.png";
import imgAvatarCircle10 from "./d270edbb86ce9a31957835d2db864cde3cf25734.png";
import imgAvatarCircle11 from "./d9bbc22e515175cfef050c1bc17c14b6a986cf2e.png";
import imgAvatarCircle12 from "./d895df3755505ef3af8d80e71522d52a7e5f1d50.png";
import imgAvatarCircle13 from "./78a56f17759aef4a48c923dc2bcc04a5b296bf0d.png";
import imgAvatarCircle14 from "./0c9b539f7dc225c75c3616a88e5e006057c1f646.png";
import imgAvatarCircle15 from "./d3a208331b29eccdbc470584100d552302c63856.png";

function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center px-[24px] py-[8px] right-0 top-[1068px] w-[1164px]" data-name="Footer">
    ...
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">Patients</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift1 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] text-left whitespace-nowrap">Patient Details</p>
        </div>
      </div>
    </div>
  );
