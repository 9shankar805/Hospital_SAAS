import svgPaths from "./svg-cy1ffjy0ki";
import imgAvatarCircle from "./48d5fb754bab06da434457f4083597ddd960fa67.png";
import imgAvatarCircle1 from "./6663b51aac3f6fc26605d36a2a8bbe19b2c719dd.png";
import imgAvatarCircle2 from "./019d5dacc4c1d1c9780bf7a5079ac2ec4ba7e382.png";
import imgAvatarCircle3 from "./305bdca5e4a9af76f88455862769d31f975f3178.png";
import imgAvatarCircle4 from "./940f76a3a006118d5ba7ce61baaa85f577521824.png";
import imgAvatarCircle5 from "./a5cde8cf149e84b9ecf0c8aafc20d2442100dc00.png";
import imgAvatarCircle6 from "./004e825309b558f8d02ca77dc9a8d61717d30494.png";
import imgAvatarCircle7 from "./c497c49e7aa98cd93656c99a3757b39ea3adb096.png";
import imgAvatarCircle8 from "./bb46851860822b9c3bb8c8aaa92d99ae5a2fbd9a.png";
import imgAvatarCircle9 from "./7c6772ae99b49625db60caab17f829a398fe9c46.png";
import imgAvatarCircle10 from "./a5fbfff2e67f1d4efdbe09364aea500b8678cdc6.png";
import imgAvatarCircle11 from "./6e52dc2fdd038a0d604b0030562d80b17dad6bd5.png";
import imgAvatarCircle12 from "./1e725a5e54c972f91119058e0da4321b9f8ce6d1.png";
import imgAvatarCircle13 from "./fd46eb7af41ded697fa4a3278bf53c12e4622e96.png";
import imgAvatarCircle14 from "./58e3ca331876af8e3b07a5a51b4451e0cc42eeb9.png";
import imgAvatarCircle15 from "./504cac1ef08240f21eda51f423d66272bb115008.png";
import imgAvatarCircle16 from "./cdc4bbef6f4f37772bb58c72d51d885874827e93.png";
import imgAvatarCircle17 from "./988a0a0400c0ded93dff619b7f16c526ec4c56dd.png";
import imgAvatarCircle18 from "./90f1061ab371ad843376b3e2c9b044a38174b4aa.png";
import imgAvatarCircle19 from "./0108e4adcb03317ca71930badce132cf9fecc9b6.png";
import imgAvatarCircle20 from "./d3a208331b29eccdbc470584100d552302c63856.png";

function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center px-[24px] py-[8px] right-0 top-[978.59px] w-[1164px]" data-name="Footer">
      <div aria-hidden className="absolute border-[#e7e8eb] border-solid border-t inset-[-1px_0_0_0] pointer-events-none" />
      <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] min-w-px not-italic relative text-[#0a1b39] text-[0px] text-center">
        <p className="text-[14px]">
          <span className="leading-[21px]">{`2025 © `}</span>
          <span className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic text-[#2e37a4]">Preclinic</span>
...
function TitleContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[339px]" data-name="Title Container">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[24px] not-italic relative shrink-0 text-[#0a1b39] text-[20px] whitespace-nowrap">Appointment</p>
    </div>
  );
}
...
function ListView() {
  return (
    <div className="bg-[#f5f6f8] content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex items-center p-[5px] relative rounded-[5px] shrink-0" data-name="List View">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="List View Icon">
        ...
        <div className="absolute bottom-3/4 left-[37.5%] right-[16.67%] top-1/4" data-name="Vector">
          <div className="absolute inset-[-0.5px_-7.79%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7.41667 1">
              <path d="M0.5 0.5H6.91667" id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
...
function ListView1() {
  return (
    <div className="content-stretch flex items-center p-[5px] relative rounded-[6px] shrink-0" data-name="List View">
      <div className="overflow-clip relative shrink-0 size-[14px]" data-name="Calendar View Icon">
        <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
          <g id="Vector" />
        </svg>
        <div className="absolute inset-[20.83%_16.67%_12.5%_16.67%]" data-name="Vector">
          <div className="absolute inset-[-5.36%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 10.3333">
              <path d={svgPaths.p2d87e100} id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[12.5%_33.33%_70.83%_66.67%]" data-name="Vector">
          <div className="absolute inset-[-21.43%_-0.5px]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1 3.33333">
              <path d="M0.5 0.5V2.83333" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        ...
        <div className="absolute inset-[45.83%_16.67%_54.17%_16.67%]" data-name="Vector">
          <div className="absolute inset-[-0.5px_-5.36%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 1">
              <path d="M0.5 0.5H9.83333" id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
        <div className="absolute inset-[62.5%_58.33%_29.17%_33.33%]" data-name="Vector">
          <div className="absolute inset-[-42.86%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 2.16667 2.16667">
              <path d={svgPaths.pd6c46c0} id="Vector" stroke="var(--stroke-0, #6B7280)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function ViewOptions() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="View Options">
      <ListView />
      <ListView1 />
    </div>
  );
...
function ViewLayout() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex gap-[4px] items-center p-[4px] relative rounded-[6px] shrink-0" data-name="View layout">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
      <ViewOptions />
    </div>
  );
}
...
function NewAppointmentButton() {
  return (
    <div className="content-stretch flex items-center justify-end relative shrink-0" data-name="New Appointment Button">
      <div className="bg-[#2e37a4] content-stretch flex gap-[4px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">New Appointment</p>
      </div>
    </div>
  );
}
...
function HeaderActions() {
  return (
    <div className="content-stretch flex gap-[12px] items-center justify-end relative shrink-0 w-[494.167px]" data-name="Header Actions">
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex gap-[8px] h-[32px] items-center px-[12px] py-[6px] relative rounded-[6px] shrink-0" data-name="Action Left">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
        <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function Search1() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Search">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] not-italic relative shrink-0 text-[#9da4b0] text-[14px] whitespace-nowrap">
  ...
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Search Container">
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col h-[32px] items-start justify-center pl-[12px] pr-[6px] py-[6px] relative rounded-[6px] shrink-0 w-[250px]" data-name="Search Input">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-[6px]" />
        <Search />
      </div>
    </div>
  );
...
function SearchAndDateContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0 w-[508.5px]" data-name="Search and Date Container">
      <SearchContainer />
...
function Dropdown() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Dropdown">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] not-italic relative shrink-0 text-[#111827] text-[14px] w-[47px]">
...
function SortBy() {
  return (
    <div className="content-stretch flex gap-[8px] h-full items-center relative shrink-0" data-name="Sort By">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Regular',sans-serif] font-normal h-full justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] w-[57px]">
...
function SortAndFilterContainer() {
  return (
    <div className="content-stretch flex gap-[12px] items-center relative shrink-0" data-name="Sort and Filter Container">
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex gap-[8px] h-[32px] items-center px-[12px] py-[6px] relative rounded-[6px] shrink-0" data-name="Action Right">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
      ...
      <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex h-[32px] items-center px-[12px] py-[6px] relative rounded-[5px] shrink-0" data-name="Sort By Dropdown order">
        <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[6px]" />
        <SortBy />
      </div>
    </div>
  );
...
function FiltersContainer1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-w-px relative" data-name="Filters Container">
...
function FiltersContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[1116px]" data-name="Filters Container">
      <FiltersContainer1 />
    </div>
  );
}
...
function HeaderContainer() {
  return (
    <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Header Container">
      <HeaderContainer1 />
      <div className="h-0 relative shrink-0 w-[1116.333px]">
        <div className="absolute inset-[-0.5px_0]">
          <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 1116.33 1">
            <path d="M0 0.5H1116.33" id="Line 1" stroke="var(--stroke-0, #E7E8EB)" />
          </svg>
        </div>
      </div>
      <FiltersContainer />
...
function DateHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Date Header">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function DateRowContent2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">30 Apr 2025 - 09:30 AM</p>
    </div>
  );
}

function DateRowContent1() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent2 />
    </div>
  );
}

function DateRowContent() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Date Row Content">
      <DateRowContent1 />
    </div>
  );
}
...
function DateRowContent5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">15 Apr 2025 - 11:20 AM</p>
    </div>
  );
}

function DateRowContent4() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent5 />
    </div>
...
function DateRowContent8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">02 Apr 2025 - 08:15 AM</p>
    </div>
  );
}

function DateRowContent7() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent8 />
    </div>
...
function DateRowContent11() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">27 Mar 2025 - 02:00 PM</p>
    </div>
  );
}

function DateRowContent10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent11 />
    </div>
...
function DateRowContent12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">12 Mar 2025 - 05:40 PM</p>
    </div>
  );
}
...
function DateRowContent15() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">05 Mar 2025 - 11:15 AM</p>
    </div>
  );
}

function DateRowContent14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent15 />
    </div>
...
function DateRowContent18() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">24 Feb 2025 - 09:20 AM</p>
    </div>
  );
}

function DateRowContent17() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Date Row Content">
      <DateRowContent18 />
    </div>
  );
}

function DateRowContent16() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent17 />
    </div>
  );
}
...
function DateRowContent21() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">16 Feb 2025 - 11:40 AM</p>
    </div>
  );
}

function DateRowContent20() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent21 />
    </div>
...
function DateRowContent24() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[100px]" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">01 Feb 2025 - 04:00 PM</p>
    </div>
  );
}

function DateRowContent23() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Date Row Content">
      <DateRowContent24 />
    </div>
...
function DateRowContent22() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[107px]" data-name="Date Row Content">
      <DateRowContent23 />
    </div>
  );
}
...
function DateRowContent27() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">25 Jan 2025 - 03:10 PM</p>
    </div>
  );
}

function DateRowContent26() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[130px]" data-name="Date Row Content">
      <DateRowContent27 />
    </div>
  );
}

function DateRowContent25() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Date Row Content">
      <DateRowContent26 />
    </div>
...
function DateRows() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Date Rows">
      <DateRow />
      <DateRow1 />
      <DateRow2 />
      <DateRow3 />
...
function DateColumn() {
  return (
    <div className="flex flex-row items-center self-stretch">
      <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[225px]" data-name="Date Column">
        <DateHeader />
        <DateRows />
      </div>
    </div>
...
function PatientHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Patient Header">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function PatientNameContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Alberto Ripley</p>
    </div>
  );
}
...
function PatientContactContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 56556 54565</p>
    </div>
  );
}
...
function PatientInfo() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
...
function PatientRowContent() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Patient Row Content">
...
function PatientRow() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Patient Row">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <PatientRowContent />
...
function PatientInfo1() {
  return <div className="h-[21px] mb-[-21px] relative shrink-0 w-[152.333px]" data-name="Patient Info" />;
}

function PatientNameContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Susan Babin</p>
    </div>
  );
}
...
function PatientContactContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 65658 95654</p>
    </div>
  );
}
...
function PatientNameContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Carol Lam</p>
    </div>
  );
}
...
function PatientContactContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 55654 56647</p>
    </div>
  );
}
...
function PatientNameContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Marsha Noland</p>
    </div>
  );
}
...
function PatientContactContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 65668 54558</p>
    </div>
  );
}
...
function PatientNameContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Irma Armstrong</p>
    </div>
  );
}
...
function PatientContactContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 45214 66568</p>
    </div>
  );
}

function PatientInfo8() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
...
function PatientInfo9() {
  return <div className="h-[21px] mb-[-21px] relative shrink-0 w-[152.333px]" data-name="Patient Info" />;
}

function PatientNameContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Jesus Adams</p>
    </div>
  );
}

function PatientContactContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 41254 45214</p>
    </div>
  );
}

function PatientInfo10() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
      <PatientNameContainer5 />
      <PatientContactContainer5 />
    </div>
  );
}

function PatientRowContent5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Patient Row Content">
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function PatientInfo11() {
  return <div className="h-[21px] mb-[-21px] relative shrink-0 w-[152.333px]" data-name="Patient Info" />;
}

function PatientNameContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Ezra Belcher</p>
    </div>
  );
}

function PatientContactContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 65895 41247</p>
    </div>
  );
}

function PatientInfo12() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
      <PatientNameContainer6 />
      <PatientContactContainer6 />
    </div>
  );
}

function PatientRowContent6() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Patient Row Content">
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function PatientInfo13() {
  return <div className="h-[21px] mb-[-21px] relative shrink-0 w-[152.333px]" data-name="Patient Info" />;
}

function PatientNameContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Glen Lentz</p>
    </div>
  );
}

function PatientContactContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 62458 45845</p>
    </div>
  );
}

function PatientInfo14() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
      <PatientNameContainer7 />
      <PatientContactContainer7 />
    </div>
  );
}

function PatientRowContent7() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Patient Row Content">
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function PatientInfo15() {
  return <div className="h-[21px] mb-[-21px] relative shrink-0 w-[152.333px]" data-name="Patient Info" />;
}

function PatientNameContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Bernard Griffith</p>
    </div>
  );
}

function PatientContactContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 61422 45214</p>
    </div>
  );
}

function PatientInfo16() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
      <PatientNameContainer8 />
      <PatientContactContainer8 />
    </div>
  );
}

function PatientRowContent8() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Patient Row Content">
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function PatientInfo17() {
  return <div className="h-[21px] mb-[-21px] relative shrink-0 w-[152.333px]" data-name="Patient Info" />;
}

function PatientNameContainer9() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Name Container">
      <p className="[word-break:break-word] font-['Inter:Medium',sans-serif] font-medium leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">John Elsass</p>
    </div>
  );
}

function PatientContactContainer9() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Patient Contact Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">+1 47851 26371</p>
    </div>
  );
}

function PatientInfo18() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Patient Info">
      <PatientNameContainer9 />
      <PatientContactContainer9 />
    </div>
  );
}

function PatientRowContent9() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Patient Row Content">
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function PatientRows() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px relative w-full" data-name="Patient Rows">
      <PatientRow />
      <PatientRow1 />
      <PatientRow2 />
      <PatientRow3 />
...
function PatientColumn() {
  return (
    <div className="flex flex-[1_0_0] flex-row items-center self-stretch">
      <div className="content-stretch flex flex-[1_0_0] flex-col h-full items-start min-w-px relative" data-name="Patient Column">
        <PatientHeader />
        <PatientRows />
      </div>
    </div>
...
function DoctorHeader() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Doctor Header">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
...
function DoctorNameContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Mick Thompson</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Cardiologist</p>
    </div>
  );
}
...
function DoctorRowContent() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Doctor Row Content">
      <div className="relative shrink-0 size-[40px]" data-name="Avatar Circle">
...
function DoctorRow() {
  return (
    <div className="bg-white relative shrink-0 w-full" data-name="Doctor Row">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[12px] relative size-full">
          <DoctorRowContent />
...
function DoctorNameContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Sarah Johnson</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Orthopedic Surgeon</p>
    </div>
  );
}
...
function DoctorNameContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Emily Carter</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Pediatrician</p>
    </div>
  );
}
...
function DoctorInfo4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Doctor Info">
...
function DoctorInfo3() {
  return (
    <div className="content-stretch flex items-start relative shrink-0 w-full" data-name="Doctor Info">
      <DoctorInfo4 />
    </div>
  );
}
...
function DoctorNameContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. David Lee</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer3() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Gynecologist</p>
    </div>
  );
}
...
function DoctorNameContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Anna Kim</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer4() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Psychiatrist</p>
    </div>
  );
}
...
function DoctorNameContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. John Smith</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer5() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Neurosurgeon</p>
    </div>
  );
}
...
function DoctorNameContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Lisa White</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer6() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Oncologist</p>
    </div>
  );
}

function DoctorInfo13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-w-px relative" data-name="Doctor Info">
...
function DoctorNameContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Patricia Brown</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer7() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Pulmonologist</p>
    </div>
  );
}

function DoctorInfo15() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Doctor Info">
...
function DoctorNameContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Rachel Green</p>
    </div>
  );
}
...
function DoctorSpecialtyContainer8() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Specialty Container">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">Urologist</p>
    </div>
  );
}

function DoctorInfo16() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[152.333px]" data-name="Doctor Info">
...
function DoctorNameContainer9() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Dr. Michael Smith</p>
    </div>
  );
}
...
function DoctorRows() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Doctor Rows">
      <DoctorRow />
      <DoctorRow1 />
      <DoctorRow2 />
      <DoctorRow3 />
...
function DoctorColumn() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-[227px]" data-name="Doctor Column">
      <DoctorHeader />
      <DoctorRows />
    </div>
  );
...
function ModeRows() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Mode Rows">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">In-person</p>
        </div>
      </div>
    </div>
  );
...
function ModeRow() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px relative w-full" data-name="Mode Row">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">Online</p>
        </div>
      </div>
    </div>
  );
...
function ModeColumn() {
  return (
    <div className="flex flex-row items-center self-stretch">
      <div className="content-stretch flex flex-col h-full items-start justify-center relative shrink-0 w-[125.667px]" data-name="Mode Column">
        <ModeHeader />
        <ModeRows />
        <ModeRow />
        <ModeRow1 />
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#e9f8fb] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#06aed4] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
            <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#06aed4] text-[13px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#fefbf5] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#e2b93b] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
            <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#e2b93b] text-[13px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#fef4f4] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#ef1e1e] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
            <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#ef1e1e] text-[13px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#f4f9fe] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#2f80ed] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
            <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#2f80ed] text-[13px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#f4fbf7] content-stretch flex h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#27ae60] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
            <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#27ae60] text-[13px] whitespace-nowrap">
...
function ActionsColumn() {
  return (
    <div className="bg-white h-[45px] relative shrink-0 w-full" data-name="Actions Column">
      <div aria-hidden className="absolute border-[#e7e8eb] border-b border-solid inset-0 pointer-events-none" />
      <div className="flex flex-col justify-center size-full">
...
function ActionsIcon1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Actions Icon">
...
function StatusRow10() {
  return (
    <div className="flex flex-row items-center self-stretch">
      <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[126px]" data-name="Status Row">
        <ActionsColumn />
        <ActionsRow />
        <ActionsRow1 />
        <ActionsRow2 />
...
function AppointmentsContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-full" data-name="Appointments Container">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none" />
      <DateColumn />
      <PatientColumn />
      <DoctorColumn />
      <ModeColumn />
...
function Input() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex gap-[8px] h-[32px] items-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Input">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-1px] pointer-events-none rounded-[7px]" />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">10</p>
      <div className="overflow-clip relative shrink-0 size-[12px]" data-name="chevron-down">
        <div className="absolute bottom-[37.5%] left-1/4 right-1/4 top-[37.5%]" data-name="Vector">
          <div className="absolute inset-[-16.67%_-8.33%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 7 4">
...
function ResultCounts() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Result Counts">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Show</p>
      <Input />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Results</p>
    </div>
  );
}
...
function Previous() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-[6px] relative rounded-[5px] shrink-0 size-[32px]" data-name="Previous">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-0.5px] pointer-events-none rounded-[5.5px]" />
...
function Number() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-[6px] relative rounded-[5px] shrink-0 size-[32px]" data-name="Number">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-0.5px] pointer-events-none rounded-[5.5px]" />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal h-[21px] leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-[7px]">1</p>
    </div>
  );
}
...
function Number1() {
  return (
    <div className="bg-[#2e37a4] content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-[6px] relative rounded-[5px] shrink-0 size-[32px]" data-name="Number">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal h-[21px] leading-[21px] not-italic relative shrink-0 text-[14px] text-white w-[9px]">2</p>
    </div>
  );
}
...
function Number2() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-[6px] relative rounded-[5px] shrink-0 size-[32px]" data-name="Number">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-0.5px] pointer-events-none rounded-[5.5px]" />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal h-[21px] leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-[9px]">3</p>
    </div>
  );
}
    ...
    <div className="relative shrink-0 size-[32px]" data-name="Number">
      <div className="absolute inset-[-1.56%_-4.69%_-7.81%_-4.69%]">
        <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 35 35">
          <g filter="url(#filter0_d_1_23148)" id="Number">
          ...
          <defs>
            <filter colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse" height="35" id="filter0_d_1_23148" width="35" x="0" y="0">
              ...
              <feBlend in2="BackgroundImageFix" mode="normal" result="effect1_dropShadow_1_23148" />
              <feBlend in="SourceGraphic" in2="effect1_dropShadow_1_23148" mode="normal" result="shape" />
            </filter>
          </defs>
        </svg>
      </div>
...
function Number4() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex flex-col items-center justify-center p-[6px] relative rounded-[5px] shrink-0 size-[32px]" data-name="Number">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-[-0.5px] pointer-events-none rounded-[5.5px]" />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal h-[21px] leading-[21px] not-italic relative shrink-0 text-[#0a1b39] text-[14px] w-[15px]">12</p>
    </div>
  );
}
...
function MainContainer() {
  return (
    <div className="absolute content-stretch flex flex-col items-start left-[300px] top-[75.59px] w-[1116px]" data-name="Main Container">
      <MainContainer1 />
    </div>
  );
}
...
function Calendar() {
  return (
    <div className="bg-white content-stretch drop-shadow-[0px_1px_0.5px_rgba(0,0,0,0.05)] flex items-center p-[8px] relative rounded-[20px] shrink-0" data-name="Calendar">
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-[20px]" />
  ...
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Avatar Container">
      <div className="relative shrink-0 size-[32px]" data-name="Avatar Circle">
        <img alt="" className="absolute block inset-0 max-w-none size-full" height="32" src={imgAvatarCircle20} width="32" />
      </div>
  ...
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Container">
      <div className="bg-gradient-to-r content-stretch flex from-[#2e37a4] gap-[4px] h-[32px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0 to-[#0e9384]" data-name="Button">
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">AI Assistance</p>
...
function Details() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start not-italic relative shrink-0 w-[107px]" data-name="Details">
...
function MenuName() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Menu Name">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] whitespace-nowrap">
  ...
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full" data-name="Container">
      <div className="content-stretch flex items-center justify-center relative shrink-0" data-name="Menu">
        <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#858d9c] text-[13px] whitespace-nowrap">
...
function MenuName4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Menu Name">
      ...
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#0a1b39] text-[14px] text-left whitespace-nowrap">
...
function Container23() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Container">
      <a className="cursor-pointer relative rounded-[6px] shrink-0 w-full" data-name="Menu">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative size-full">
            <MenuName4 />
            <div className="overflow-clip relative shrink-0 size-[14px]" data-name="chevron-right">
...
function Container24() {
  return (
    <a className="content-stretch cursor-pointer flex flex-col gap-[4px] items-start relative shrink-0 w-full" data-name="Container">
      <div className="relative rounded-[6px] shrink-0 w-full" data-name="Menu">
        <div className="flex flex-row items-center size-full">
          <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative size-full">
            <MenuName5 />
    ...
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">Appointments</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift1 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">New Appointment</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift2 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Calendar</p>
        </div>
      </div>
    </div>
  );
          ...
          <div className="content-stretch flex gap-[8px] items-center px-[12px] py-[8px] relative size-full">
            <div className="overflow-clip relative shrink-0 size-[14px]" data-name="calendar-check">
              <div className="absolute inset-[20.83%_16.67%_12.5%_16.67%]" data-name="Vector">
                <div className="absolute inset-[-5.36%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 10.3333">
                    <path d={svgPaths.p41cf800} id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
              <div className="absolute inset-[12.5%_33.33%_70.83%_66.67%]" data-name="Vector">
              ...
              <div className="absolute inset-[45.83%_16.67%_54.17%_16.67%]" data-name="Vector">
                <div className="absolute inset-[-0.5px_-5.36%]">
                  <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.3333 1">
                    <path d="M0.5 0.5H9.83333" id="Vector" stroke="var(--stroke-0, #2E37A4)" strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
              </div>
            ...
            <div className="[word-break:break-word] flex flex-[1_0_0] flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] min-w-px not-italic relative text-[#2e37a4] text-[14px]">
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift3 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Leaves</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift4 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Leave Type</p>
        </div>
      </div>
    </div>
  );
        ...
        <div className="absolute inset-[37.5%_16.67%_37.5%_29.17%]" data-name="Vector">
          <div className="absolute inset-[-14.29%_-6.59%]">
            <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 8.58333 4.5">
              <path d={svgPaths.p16ceb700} id="Vector" stroke="var(--stroke-0, #0A1B39)" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </div>
        </div>
      </div>
...
function Container6() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border-[#e7e8eb] border-r border-solid inset-0 pointer-events-none" />
      <Container7 />
      <Container12 />
    </div>
  );
...
function Container86() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col gap-[4px] h-[69.75px] items-start leading-[21px] not-italic relative shrink-0 text-[14px] text-center w-full" data-name="Container">
...
function DarkMode() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="Dark Mode">
      ...
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Medium',sans-serif] font-medium leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Dark Mode</p>
      <button className="bg-[#e7e8eb] content-stretch cursor-pointer flex h-[16px] items-center p-[4px] relative rounded-[8px] shrink-0 w-[30px]" data-name="Switcher">
        <div className="bg-[rgba(255,255,255,0.8)] h-[8px] relative rounded-[6px] shrink-0 w-[7.991px]" />
      </button>
    </div>
  );
}
...
function Container79() {
  return (
    <div className="relative shrink-0 w-full" data-name="Container">
      <div aria-hidden className="absolute border-[#e7e8eb] border-r border-solid border-t inset-0 pointer-events-none" />
      <div className="content-stretch flex flex-col items-start p-[24px] relative size-full">
        <Container80 />
      </div>
    </div>
...
function SidebarScroll() {
  return (
    <div className="absolute content-stretch flex h-[1066px] items-start left-0 top-[-0.41px]" data-name="Sidebar  Scroll">
...
export default function Appointment() {
  return (
    <div className="bg-[#f5f6f8] relative size-full" data-name="Appointment">
      <Footer />
      <MainContainer />
