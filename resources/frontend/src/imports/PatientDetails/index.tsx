import svgPaths from "./svg-phvwtil0v8";
import imgDoctorImage from "./f72927d1e12c6e7764364de6a1d6dfa17e92717e.png";
import imgAvatarCircle from "./a5fbfff2e67f1d4efdbe09364aea500b8678cdc6.png";
import imgAvatarCircle1 from "./6e52dc2fdd038a0d604b0030562d80b17dad6bd5.png";
import imgAvatarCircle2 from "./1e725a5e54c972f91119058e0da4321b9f8ce6d1.png";
import imgAvatarCircle3 from "./fd46eb7af41ded697fa4a3278bf53c12e4622e96.png";
import imgAvatarCircle4 from "./58e3ca331876af8e3b07a5a51b4451e0cc42eeb9.png";
import imgAvatarCircle5 from "./504cac1ef08240f21eda51f423d66272bb115008.png";
import imgAvatarCircle6 from "./cdc4bbef6f4f37772bb58c72d51d885874827e93.png";
import imgAvatarCircle7 from "./988a0a0400c0ded93dff619b7f16c526ec4c56dd.png";
import imgAvatarCircle8 from "./90f1061ab371ad843376b3e2c9b044a38174b4aa.png";
import imgAvatarCircle9 from "./0108e4adcb03317ca71930badce132cf9fecc9b6.png";
import imgAvatarCircle10 from "./d3a208331b29eccdbc470584100d552302c63856.png";

function Footer() {
  return (
    <div className="absolute bg-white content-stretch flex items-center justify-center px-[24px] py-[8px] right-0 top-[1387px] w-[1164px]" data-name="Footer">
...
function Header() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Header">
      ...
      <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] not-italic relative shrink-0 text-[14px] text-black whitespace-nowrap">Patients</p>
    </div>
  );
}
...
function DoctorNameContainer() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Doctor Name Container">
      <p className="[word-break:break-word] font-['Inter:Bold',sans-serif] font-bold leading-[21.6px] not-italic relative shrink-0 text-[#0a1b39] text-[18px] whitespace-nowrap">Alberto Ripley</p>
    </div>
  );
}
...
function DoctorDetails() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px relative" data-name="Doctor Details">
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">#PT0025</p>
      <DoctorNameContainer />
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">4150 Hiney Road, Las Vegas, NV 89109</p>
    </div>
  );
}
...
function PhoneContainer2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Phone Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
...
function LastVisitContainer2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Last Visit Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-pre">
  ...
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0" data-name="Consultation Info">
      ...
      <div className="bg-[#2e37a4] content-stretch flex gap-[4px] h-[32px] items-center justify-center px-[10px] py-[6px] relative rounded-[6px] shrink-0" data-name="Button">
        ...
        <p className="[word-break:break-word] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[19.5px] not-italic relative shrink-0 text-[13px] text-center text-white whitespace-nowrap">Book Apppointment</p>
      </div>
    </div>
  );
}
    ...
    <div className="bg-white h-[160px] relative rounded-[6px] shrink-0 w-full" data-name="Content">
      <div className="overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex gap-[18px] items-start p-[20px] relative size-full">
          <DoctorInfo />
          <div className="absolute flex h-[249.947px] items-center justify-center left-[528.58px] top-[-79.97px] w-[235.829px]">
            <div className="flex-none rotate-[-39.65deg]">
              <div className="h-[226px] relative w-[119px]">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 119 226">
                  <path d={svgPaths.p25bba400} fill="url(#paint0_linear_1_10910)" id="Vector 7" />
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_10910" x1="38" x2="87.5" y1="22.5" y2="185">
          ...
          <div className="absolute flex h-[286.59px] items-center justify-center left-[572.03px] top-[-43.29px] w-[260.575px]">
            <div className="flex-none rotate-[39.19deg]">
              <div className="h-[285.24px] relative w-[103.666px]">
                <svg className="absolute block inset-0 size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 103.666 285.24">
                  <path d={svgPaths.p43b8080} fill="url(#paint0_linear_1_11670)" id="Vector 8" />
                  <defs>
                    <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_11670" x1="15.8809" x2="65.2747" y1="24.8214" y2="240.918">
      ...
      <div aria-hidden className="absolute border border-[#e7e8eb] border-solid inset-0 pointer-events-none rounded-[6px] shadow-[0px_1px_1px_0px_rgba(0,0,0,0.05)]" />
    </div>
  );
}
...
function AboutTitleContainer() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[8px] items-center min-w-px relative" data-name="About Title Container">
      ...
      <p className="[word-break:break-word] flex-[1_0_0] font-['Instrument_Sans:Bold',sans-serif] font-bold leading-[21.6px] min-w-px relative text-[#111827] text-[18px]" style={{ fontVariationSettings: '"wdth" 100' }}>
        About
      </p>
    </div>
  );
...
function AboutHeader() {
  return (
    <div className="bg-white relative rounded-tl-[6px] rounded-tr-[6px] shrink-0 w-full" data-name="About Header">
      <div aria-hidden className="absolute border-[#e5e7eb] border-b border-solid inset-[0_0_-1px_0] pointer-events-none rounded-tl-[6px] rounded-tr-[6px]" />
...
function DobInfoContainer() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start min-w-px not-italic relative" data-name="DOB Info Container">
...
function BloodGroupInfoContainer() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-col items-start not-italic relative shrink-0 whitespace-nowrap" data-name="Blood Group Info Container">
...
function GenderInfoContainer() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start min-w-px not-italic relative" data-name="Gender Info Container">
...
function EmailInfoContainer() {
  return (
    <div className="[word-break:break-word] content-stretch flex flex-[1_0_0] flex-col items-start min-w-px not-italic relative" data-name="Email Info Container">
...
function BloodPressureLabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Blood Pressure Label Container">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Blood Pressure</p>
    </div>
  );
}
...
function BloodPressureValueContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Blood Pressure Value Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">100/67 mmHg</p>
    </div>
  );
}
...
function HeartRateLabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Heart Rate Label Container">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Heart Rate</p>
    </div>
  );
}
...
function HeartRateValueContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Heart Rate Value Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">89 Bpm</p>
    </div>
  );
}
...
function Spo2LabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="SPO2 Label Container">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">SPO2</p>
    </div>
  );
}
...
function Spo2ValueContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="SPO2 Value Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">98 %</p>
    </div>
  );
}
...
function TemperatureLabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Temperature Label Container">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Temperature</p>
    </div>
  );
}
...
function TemperatureValueContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Temperature Value Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">101 C</p>
    </div>
  );
}
...
function RespiratoryRateLabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Respiratory Rate Label Container">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Respiratory rate</p>
    </div>
  );
}
...
function RespiratoryRateValueContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Respiratory Rate Value Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">24 rpm</p>
    </div>
  );
}
...
function WeightLabelContainer() {
  return (
    <div className="content-stretch flex items-center justify-center relative shrink-0 w-full" data-name="Weight Label Container">
      <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">Weight</p>
    </div>
  );
}
...
function WeightValueContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0 w-full" data-name="Weight Value Container">
      ...
      <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[19.5px] not-italic relative shrink-0 text-[#6c7688] text-[13px] whitespace-nowrap">100 kg</p>
    </div>
  );
}
...
function AppointmentsTab() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[12px] py-[4px] relative shrink-0" data-name="Appointments Tab">
      <div aria-hidden className="absolute border-[#2e37a4] border-b border-solid inset-[0_0_-1px_0] pointer-events-none" />
      <div className="[word-break:break-word] flex flex-col font-['Inter:Semi_Bold',sans-serif] font-semibold justify-center leading-[0] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">
...
function TransactionsTab() {
  return (
    <div className="content-stretch flex flex-col items-center justify-center px-[12px] py-[4px] relative shrink-0" data-name="Transactions Tab">
      <div className="[word-break:break-word] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-center leading-[0] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#e9f8fb] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#ecf7fb] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#fefbf5] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#fcf8eb] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#fef4f4] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#fde9e9] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#f4f9fe] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#eaf2fd] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
      ...
      <div className="flex flex-col justify-center size-full">
        <div className="content-stretch flex flex-col items-start justify-center px-[16px] py-[8px] relative size-full">
          <div className="bg-[#f4fbf7] content-stretch flex gap-[4px] h-[24px] items-center justify-center px-[8px] py-[4px] relative rounded-[6px] shrink-0" data-name="Badge">
            <div aria-hidden className="absolute border border-[#e9f7ef] border-solid inset-[-0.5px] pointer-events-none rounded-[6.5px]" />
    ...
    <div className="bg-[#f5f6f8] relative rounded-[6px] shrink-0 w-full" data-name="Dropdown Option">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[7px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#0a1b39] text-[14px]">View Details</p>
        </div>
      </div>
    </div>
  );
...
function DropdownOption1() {
  return (
    <div className="relative rounded-[6px] shrink-0 w-full" data-name="Dropdown Option">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="content-stretch flex items-center justify-center px-[8px] py-[7px] relative size-full">
          <p className="[word-break:break-word] flex-[1_0_0] font-['Inter:Regular',sans-serif] font-normal leading-[21px] min-w-px not-italic relative text-[#6c7688] text-[14px]">Delete</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] whitespace-nowrap">Patients</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift1 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#2e37a4] text-[14px] whitespace-nowrap">Patient Details</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="relative shrink-0 w-full" data-name="Menu Name">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center px-[16px] relative size-full">
          <Gift2 />
          <p className="[word-break:break-word] font-['Inter:Regular',sans-serif] font-normal leading-[21px] not-italic relative shrink-0 text-[#6c7688] text-[14px] text-left whitespace-nowrap">Create Patient</p>
        </div>
      </div>
    </div>
  );
...
function Container26() {
  return (
    <div className="content-stretch flex flex-col gap-[4px] items-start py-[8px] relative shrink-0" data-name="Container">
      ...
      <a className="content-stretch cursor-pointer flex flex-col h-[32px] items-start relative shrink-0 w-[228px]" data-name="Submenu">
        <MenuName7 />
      </a>
    </div>
  );
